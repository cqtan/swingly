...
import {
  AboutPageContainer, H1, H2, H3, ContentContainer, Content, ContentRow, Icon, AboutButton, ContentColumn
    ...
    <AboutPageContainer>
      <ContentContainer>
        ...
        <Content>        
          ...
          <ContentColumn>
            <b>PWA:</b> While accessible on the Desktop, it is really much meant for mobile use (Especially as a Progressive Web App).
          </ContentColumn>
          <Icon icon="caret-right" />
          <ContentColumn>
            <b>Heroku (Free tier):</b> Initial load takes a couple seconds (patience required but it's worth it!).
          </ContentColumn>
          <Icon icon="caret-right" />
          <ContentColumn>
            <b>Firebase (Free tier):</b> Because of the limited amount of requests I can make to the Firebase services, the app only serves events of the current month instead of multiple months.
          </ContentColumn>
          <Icon icon="caret-right" />
          <ContentColumn>
            <b>Cats:</b> Contains a lot of random cat images as placeholders because why not?!
          </ContentColumn>
        </Content>
        <H2>Summary</H2>
        <Content>
          <ContentRow>
            The Swingly app is a prototype and alternative to the calendar found on the SwingInBerlin website <a href="http://www.swinginberlin.de">http://www.swinginberlin.de</a> for local swing social/dance events in Berlin. It has two main purposes. On the one hand, it aims to provide a more modern UI with additional features such as:<br></br>
          </ContentRow>
          <Icon icon="caret-right" />
          <ContentColumn>
            Authentication
        ...
        <Content>
          <Icon icon="caret-right" />
          <ContentColumn>
            View not only local social events in the SwingInBerlin Calendar but also from the <a href="https://www.swingplanit.com">https://www.swingplanit.com</a> website for international swing festivals
          </ContentColumn>
          <Icon icon="caret-right" />
          <ContentColumn>
